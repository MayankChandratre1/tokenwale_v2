    ...
    const {
      ...
      const exportCSV = () => {
          const data = txns.map(txn => {
            return {
              id: txn.firestoreId,
              from: txn.from == '99999999' ? "TOKENWALE":txn.from,
              to: txn.to == '00000000' ? "BURNT":txn.to,
              date: formatFirestoreTimestamp(txn.timestamp)?.date ?? "",
          ...
          <div className="flex max-h-[500px] mt-10 w-full flex-col items-center justify-center md:w-full">
            <div className="flex w-full  flex-row justify-between gap-12 pb-6">
              ...
              <div className='flex gap-2 items-center'>
                ...
                <Button onClick={()=>{
                  exportCSV()
                }} className='bg-[#38f68f] hover:bg-[#38f68f] text-black'>
