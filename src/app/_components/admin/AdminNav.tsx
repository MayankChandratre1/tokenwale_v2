...
import ScanDialog from "../common/QrScannerPopup";

 const AdminNav = ({ toggleSidebar,handleSearch, setAddNote }: { toggleSidebar?: () => void, handleSearch?: (userId: string) => void, setAddNote?: (note:string) => void }) => {
